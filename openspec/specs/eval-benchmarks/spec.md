...
Define the eval benchmark artifacts — machine-readable run snapshots, the human-readable public scoreboard (`evals/BENCHMARKS.md`), methodology documentation, gating thresholds, and reproducible provenance — that the eval suite produces and publishes.
